...
function App() {
 ...
 const downloadQR = () => {
  ...
  img.onload = () => {
    ...
    const padding = 40; // EXTRA white border (you can increase)
   const radius = 20;           // rounded corner radius
    const text = "Generated by QR-Code-Generator"; // your footer text
    const textSize = 16;         // small text size (px)
    const textPadding = 20;      // space between QR and footer text
     canvas.width = img.width + padding * 2;
    canvas.height = img.height + padding * 2 + textSize + textPadding;
  ...
  ctx.fillRect(0, 0, canvas.width, canvas.height);
   ...
   ctx.fillStyle = "black";
    ...
    ctx.fillText(text, canvas.width / 2, img.height + padding * 2 + textSize);

  // Draw QR centered on the new white background
          ...
          <div className="qr-section" ref={qrRef}>
            ...
            <div className="qr-container">
              <div style={{ background: "#fff", padding: "16px" }}>
                <QRCode value={qrValue} size={qrSize} bgColor="#FFFFFF" fgColor="#000000" style={{ background: "white" }}
  level="H"/>
              </div>
            </div>
